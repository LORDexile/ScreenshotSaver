...
public final class Constants {
	public static final String PRODUCT_VERSION = "0.1.4.2";
	...
	public static final String TMP_PATH = PROGRAM_SOURCE_FOLDER + File.separator + "tmp";

	public static final String UNIQUE_TEST_URL_PATH = "https://text.ru/antiplagiat";
}
